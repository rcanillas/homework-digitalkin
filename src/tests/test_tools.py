...
def context_retrieval_tool():
    return ContextRetrievalTool(
        ...
        parameters={"embedding_model": "text-embedding-ada-002"},
    )
...
def test_execute_context_retrieval_tool(context_retrieval_tool, monkeypatch):
    ...
    monkeypatch.setattr(context_retrieval_tool, 'get_doc_embeddings', lambda x: context_retrieval_tool.doc_w_embeddings)
